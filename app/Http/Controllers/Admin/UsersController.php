...
class UsersController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.users.create', compact('roles', 'teams','cities'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('admin.users.edit', compact('roles', 'teams', 'user','cities'));
    }
    ...
    public function show(User $user)
    {
        ...
        $user->load('roles', 'team', 'clientBookings');
