        ...
        <form method="POST" action="{{ route("admin.offers.update", [$offer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group col-sm-12 col-md-3">
                    ...
                    <select class="form-control select2 {{ $errors->has('restaurant') ? 'is-invalid' : '' }}" name="restaurant_id" id="restaurant_id">
                        @foreach($restaurants as $id => $entry)
                            <option value="{{ $id }}" {{ (old('restaurant_id') ? old('restaurant_id') : $offer->restaurant->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-sm-12 col-md-3">
                    ...
                    <input class="form-control datetime {{ $errors->has('starting_at') ? 'is-invalid' : '' }}" type="text" name="starting_at" id="starting_at" value="{{ old('starting_at', $offer->starting_at) }}">
                ...
                <div class="form-group col-sm-12 col-md-3">
                    ...
                    <input class="form-control datetime {{ $errors->has('ending_at') ? 'is-invalid' : '' }}" type="text" name="ending_at" id="ending_at" value="{{ old('ending_at', $offer->ending_at) }}">
                ...
                <div class="form-group col-sm-12 col-md-6">
                    ...
                    <textarea class="form-control {{ $errors->has('disception') ? 'is-invalid' : '' }}" name="disception" id="disception">{{ old('disception', $offer->disception) }}</textarea>
                ...
                {{--                    <input class="form-check-input" type="checkbox" name="public" id="public" value="1" {{ $offer->public || old('public', 0) === 1 ? 'checked' : '' }}>--}}
                ...
                <div class="form-group col-sm-12 col-md-12">
                    <div class="form-check {{ $errors->has('approved') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="approved" id="approved" value="1" {{ $offer->approved || old('approved', 0) === 1 ? 'checked' : '' }}>
