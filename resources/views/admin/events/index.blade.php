                            ...
                            <td>
                                ...
                                @endif
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault{{ $event->id }}" {{ $event->approved ? 'checked' : '' }} onclick="toggleApproval({{ $event->id }})">
                                        <label class="form-check-label" for="flexSwitchCheckDefault{{ $event->id }}">{{ $event->approved ? trans('global.unapprove') :trans('global.approve') }}</label>
                                    </div>
                                    @endcan
                            </td>
...
function toggleApproval(offerId) {
    $.ajax({
        ...
        method: 'POST',
        url: "{{ route('admin.events.toggleApproval') }}",
        data: { id: offerId },
        dataType: 'json', 
