<div class="m-3">
    @can('contact_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.contacts.create') }}?id={{$restaurent->id}}">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-restaurantContacts">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.contact.fields.restaurant') }}
                            </th>
                            <th>
                                {{ trans('cruds.contact.fields.position') }}
                            </th>
                            <th>
...
@endcan
  ...
  let table = $('.datatable-restaurantContacts:not(.ajaxTable)').DataTable({ buttons: dtButtons })
