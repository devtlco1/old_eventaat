<div class="m-3">
    @can('story_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.stories.create') }}?id={{$restaurent->id}}">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-restaurantStories">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.story.fields.restaurant') }}
                            </th>
                            <th>
                                {{ trans('cruds.story.fields.file') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
                    ...
                    <tbody>
                        @foreach($stories as $key => $story)
                            <tr data-entry-id="{{ $story->id }}">
                                ...
                                <td>
                                    @if($story->file)
                                        <a href="{{ $story->file->getUrl() }}" target="_blank">
...
@can('story_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.stories.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-restaurantStories:not(.ajaxTable)').DataTable({ buttons: dtButtons })
