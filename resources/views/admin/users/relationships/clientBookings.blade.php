    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-clientBookings">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.booking.fields.call_action') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
                    ...
                    <tbody>
                        @foreach($bookings as $key => $booking)
                            <tr data-entry-id="{{ $booking->id }}">
                                ...
                                <td>
                                    <span style="display:none">{{ $booking->call_action ?? '' }}</span>
                                    <input type="checkbox" disabled="disabled" {{ $booking->call_action ? 'checked' : '' }}>
                                </td>
                                <td>
                                    @can('booking_show')
...
@endcan
  ...
  let table = $('.datatable-clientBookings:not(.ajaxTable)').DataTable({ buttons: dtButtons })
