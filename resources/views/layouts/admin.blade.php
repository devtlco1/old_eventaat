...
<head>
    ...
    <style>
      ...
      .sidebar {
          background-color: #aa1f86 !important;
      }
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="min-height: 917px;">
            ...
            {{--  <ul class="navbar-nav">
              ...
              <a class="btn btn-s btn-info" href="{{ url()->previous() }}" role="button" style="background-color: white;color: black">
                  {{ trans('global.back') }}
              </a>
          {{--  </ul>  --}}
            <!-- /.content -->
    ...
    <script>
        Array.prototype.forEach.call(document.querySelectorAll('input[type=tel]'), function (input) {
            ...
            input.addEventListener("countrychange", function(v) {
                $('#country_code_' + input.id).val(iti.getSelectedCountryData()['dialCode']);
                $('#cc_' + input.id).val(iti.getSelectedCountryData().iso2);
            });
        });
    </script>
