    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                @can('index_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/privacies*") ? "menu-open" : "" }} {{ request()->is("admin/features*") ? "menu-open" : "" }} {{ request()->is("admin/teams*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is("admin/privacies*") ? "active" : "" }} {{ request()->is("admin/features*") ? "active" : "" }}  {{ request()->is("admin/teams*") ? "active" : "" }}" href="#">
